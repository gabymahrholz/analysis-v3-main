...
![Table 2 (Lopez et al., 2024)](data/lopez_table2.png)
...
Store the new data object as `lopez_control`.
...
Filter out the 3 influential points/outliers and create the plot again. It’s best to save the data without outliers as a new data object. I’ve named mine `lopez_control_no_outliers`, but feel free to use a name that works for you.
