...
-   However, we could do with a fresh Rmd: **Create a new `.Rmd` file*** and save it to your project folder. Name it something meaningful (e.g., "chapter_04", "04_data_viz.Rmd"). See @sec-rmd if you need some guidance. Delete everything below line 12 (keep the set-up code chunk)
