...
* create a new project and name it something meaningful (e.g., "2A_chapter6", or "06_independent_ttest"). See @sec-project if you need some guidance.
