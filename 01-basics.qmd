...
Download the data for today: [filename](data/test.csv "download"). You will 

Download the data for today: [filename](https://psyteachr.github.io/ads-v2/data/review_data.csv "download"). You will 

data test fixed path <a href="https://psyteachr.github.io/ads-v2/data/review_data.csv" download>review_data.csv</a>

floating path <a href="data/test.csv" download>test.csv</a>
...
everything in the code chunks will be computed

everything in the text will be ignored by r
...
## Activity 3: Load the packages and read in the data
