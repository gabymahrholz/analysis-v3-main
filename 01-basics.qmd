...
Let’s have a closer look at our data `data_prp`. For this little quiz, we've selected a few columns, shortened some of the column names, and modified some of the data types. This is the first few rows of the new object `data_quiz`. *You can find the code at the end of this chapter.*

```{r echo=FALSE}
data_quiz <- data_prp %>% 
  select(Code, Time2_Code, Age, Gender, Ethnicity, Secondyeargrade, QRP_item = QRPs_1_Time1, QRPs_mean = QRPs_Acceptance_Time1_mean) %>% 
