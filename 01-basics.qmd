...
The data we will be using in the lab activities comes from Canada. The original study is Binfet et al. (2021).
...
Open the data files, look at the codebook, perhaps skim over the original Binfet study (methods in particular) to see what kind of measures they used. 
