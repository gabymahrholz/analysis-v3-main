...
With the design and sample size we have, we could have detected an effect as small as $f^2 = .044$. Since the observed effect size from our inferential statistics was larger ($f^2 = .074$), this means our test was sufficiently powered to detect the observed effect. 
